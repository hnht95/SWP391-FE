...
import ProfileTab from './headerComponent/userProfileComponent/userTabComponent/ProfileTab'
import SettingsTab from './headerComponent/userProfileComponent/userTabComponent/SettingsTab'
import ActivityTab from './headerComponent/userProfileComponent/userTabComponent/ActivityTab'
import BookingHistoryTab from './headerComponent/userProfileComponent/userTabComponent/BookingHistoryTab'
            ...
            <div className='flex items-center justify-between'>
              <div className='lg:pl-0 pl-12'>
                ...
                <p className='text-gray-300 text-xs lg:text-sm'>
                  ...
                  {activeTab === 'booking' && 'View your rental booking history'}
