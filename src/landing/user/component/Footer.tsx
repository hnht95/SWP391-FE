            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Link to="/" className="block text-gray-300 hover:text-gray-200 transition-colors duration-300">Home</Link>
                  <Link to="/vehicles" className="block text-gray-300 hover:text-gray-200 transition-colors duration-300">Electric Vehicles</Link>
                  <Link to="/about" className="block text-gray-300 hover:text-gray-200 transition-colors duration-300">About Us</Link>
                  <Link to="/contact" className="block text-gray-300 hover:text-gray-200 transition-colors duration-300">Contact Us</Link>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Link to="/faq" className="block text-gray-300 hover:text-gray-200 transition-colors duration-300">FAQ</Link>
                  <Link to="/terms" className="block text-gray-300 hover:text-gray-200 transition-colors duration-300">Terms of Service</Link>
                  <Link to="/privacy" className="block text-gray-300 hover:text-gray-200 transition-colors duration-300">Privacy Policy</Link>
                  <Link to="/help" className="block text-gray-300 hover:text-gray-200 transition-colors duration-300">Help Center</Link>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-700">
            <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-300">
              ...
              <div className="flex space-x-4 mt-2 md:mt-0">
                <a href="/terms" className="hover:text-gray-200 transition-colors duration-300">Terms</a>
                <a href="/privacy" className="hover:text-gray-200 transition-colors duration-300">Privacy</a>
              </div>
            </div>
          </div>
        </div>
