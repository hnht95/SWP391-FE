      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16 lg:mb-24">
        ...
        >
          ...
          <img
            ...
            className="rounded-2xl shadow-xl w-full h-auto object-cover max-h-[400px] transform-gpu transition-transform duration-500 group-hover:scale-[1.03]"
          />
        </motion.div>
        <motion.div
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg mt-4">
                ...
                reliable parking management systems across all of our branches.
              </p>
            </div>
          </div>
        </motion.div>
