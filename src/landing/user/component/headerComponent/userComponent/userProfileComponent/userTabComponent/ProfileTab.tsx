...
import EditProfileModal from "./profileComponent/EditProfileModal";
...
type KYCStatusType = "not_uploaded" | "pending" | "verified";
...
const ProfileTab = ({ user, onRefresh }: ProfileTabProps) => {
  ...
  const getKYCImageUrl = (
    image: string | KYCImage | null | undefined
  ): string | undefined => {
  ...
  return (
    <>
      <div className="space-y-8">
        ...
        >
          ...
          {avatarError && (
            <motion.p
              ...
              className="text-xs text-red-600 mb-3 flex items-center"
            >
          ...
          {isUploadingAvatar && (
            <motion.p
              initial={{ opacity: 0, y: -5 }}
              animate={{ opacity: 1, y: 0 }}
              className="text-xs text-blue-600 mb-3 flex items-center"
            >
          ...
          <motion.button
            ...
            className="w-40 flex items-center justify-center space-x-2 px-6 py-3 bg-black text-white rounded-2xl font-medium hover:bg-gray-800 transition-all duration-300 shadow-lg"
          >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {profileFields.map((field, index) => (
              ...
              >
                <div className="text-black mt-1">{field.icon}</div>
                <div className="flex-1">
            ...
            {hasBankInfo && bankInfo ? (
              <div className="space-y-3">
                ...
                {bankInfo.updatedAt && (
                  <p className="text-xs text-gray-500 flex items-center">
                    ...
                    Last updated: {formatDate(bankInfo.updatedAt)}
                  </p>
                )}
              ...
              <div>
                <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                  Add your bank account information for refunds and withdrawals
                </p>
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
        ...
        {/* KYC Status Section - Keep all existing code */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
            ...
            {kycStatus === "verified" && user.kyc && (
              <div className="mt-2">
                        ...
                        <>
                          <div className="relative">
                            <img
                              src={image.url}
                              alt={image.label}
                              className="w-full h-24 object-cover rounded-lg border-2 border-green-300 cursor-pointer transition-transform hover:scale-105"
                              onClick={() =>
                ...
                <motion.button
                  ...
                  className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-green-500 text-white rounded-lg text-xs font-medium hover:bg-green-600 transition-colors"
                >
                  <Upload className="w-4 h-4" />
