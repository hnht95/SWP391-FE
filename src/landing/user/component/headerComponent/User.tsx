...
const User: React.FC<UserProps> = ({ 
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={isLoggedIn ? () => setIsDropdownOpen(!isDropdownOpen) : handleLoginClick}
      ...
      >
        ...
        {!isLoggedIn && (
          <>
            ...
            <svg className={`w-4 h-4 text-white/80 group-hover:text-white group-hover:brightness-150 group-hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.9)] transform transition-transform duration-300 ${isDropdownOpen ? 'rotate-180' : 'rotate-0'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
