          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 pointer-events-none">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-100 bg-gradient-to-r from-blue-50/50 to-white">
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h2 className="text-lg font-bold text-gray-800">Add New Station</h2>
                  <p className="text-xs text-gray-500">Fill in the station information below</p>
                </div>
              </div>
              <button
                onClick={handleClose}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-3 py-2 text-sm border ${
                      errors.address ? "border-red-300 bg-red-50/30" : "border-gray-200 bg-gray-50/50"
                    } rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-3 py-2 text-sm border ${
                        errors.latitude ? "border-red-300 bg-red-50/30" : "border-gray-200 bg-gray-50/50"
                      } rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-3 py-2 text-sm border ${
                        errors.longitude ? "border-red-300 bg-red-50/30" : "border-gray-200 bg-gray-50/50"
                      } rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200`}
